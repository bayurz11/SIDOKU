    ...
    <div class="space-y-8 animate-fadeInUp">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            @php
                ...
                $highMoistureItems = $rawCollection
                    ->filter(fn($ipc) => $ipc->avg_moisture_percent >= 10)
                    ->map(function ($ipc) {
            ...
            <div class="px-4 py-4 sm:px-6 sm:py-5">
                ...
                @else
                    ...
                    <div class="h-56 sm:h-72 mb-6" wire:ignore>
                        <canvas id="ipcMoistureChart" data-labels='@json($chartLabels)'
                            data-values='@json($chartValues)'
                            data-counts='@json($chartCounts)'></canvas>
                    </div>
