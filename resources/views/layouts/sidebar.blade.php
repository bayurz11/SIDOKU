             ...
             <div x-data="{ activeMenu: @js($activeMenuInitial) }" class="space-y-2">
                 ...
                 @if ($canSeeMasterMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-master" x-show="activeMenu === 'master'"
                 ...
                 @if ($canSeeDocumentMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-document" x-show="activeMenu === 'document'"
                             class="mt-1 pl-10 space-y-1 overflow-hidden">
                 ...
                 @if ($canSeeIpcMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-ipc" x-show="activeMenu === 'ipc'"
                             class="mt-1 pl-10 space-y-1 overflow-hidden">
                 ...
                 @if ($canSeeIncomingMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-incoming" x-show="activeMenu === 'incoming'"
                             class="mt-1 pl-10 space-y-1 overflow-hidden">
                 ...
                 @if ($canSeeMicrobiologyMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-microbiology" x-show="activeMenu === 'microbiology'"
                             class="mt-1 pl-10 space-y-1 overflow-hidden">
                 ...
                 @if ($canSeeAccountMenu)
                     <div class="relative pt-4 mt-4 border-t border-blue-400 border-opacity-30">
                         ...
                         <div id="menu-account" x-show="activeMenu === 'account'"
                             class="mt-1 pl-10 space-y-1 overflow-hidden">
