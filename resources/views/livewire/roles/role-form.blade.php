                    ...
                    <form wire:submit="save" class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                @enderror
                                <p class="text-xs text-gray-500 mt-1">Only lowercase letters, numbers, and hyphens
                                    allowed</p>
                            </div>

                            <div>
                                <label for="display_name" class="block text-sm font-medium text-gray-700 mb-2">Display
                                    Name</label>
                                            ...
                                            @foreach ($permissions as $permission)
                                                <label
                                                    ...
                                                    <div class="flex-1 min-w-0">
                                                        <span
                                                            class="text-sm font-medium text-gray-900 block">{{ $permission->display_name }}</span>
