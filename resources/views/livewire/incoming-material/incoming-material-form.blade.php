...
<div>
    @if ($showModal)
        ...
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-start justify-center"
            ...
            <div class="relative top-8 mx-auto w-full max-w-6xl p-6 bg-white border rounded-2xl shadow-lg"
                x-data="{}">
                ...
                <form wire:submit.prevent="save" class="space-y-8">
                    ...
                    <div class="border border-gray-200 rounded-xl p-6 bg-gray-50">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            {{-- Sample --}}
                            <div>
                                <label class="text-sm font-medium">Jumlah Sampel</label>
                            ...
                            {{-- Kendaraan --}}
                            <div>
                                <label class="text-sm font-medium">Nomor Kendaraan</label>
                    ...
                    <div class="border border-green-200 rounded-xl p-6 bg-green-50/30">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <textarea wire:model.defer="inspection_notes" rows="3" class="w-full mt-1 border rounded-md p-2 text-sm"></textarea>
