                    ...
                    @foreach ($incomingData as $row)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-center">
                                @php
                                    $baseClass =
                                        'inline-flex items-center justify-center min-w-[100px] h-7 px-3 rounded-full text-xs font-semibold';
                                @endphp
                            ...
                            <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center gap-2">
                                    ...
                                    {{-- PRINT DOKUMEN --}}
                                    @permission('incoming_material.print')
                                    ...
                                    @permission('incoming_material.delete')
                                        <button x-on:click="$dispatch('confirm-delete', {{ $row->id ?? 1 }})"
                                            ...
                                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6 m1-10V4a1 1 0 00-1-1H9a1 1 0 00-1 1v3M4 7h16" />
                                            </svg>
                                            Delete
                                        </button>
                                    @endpermission
