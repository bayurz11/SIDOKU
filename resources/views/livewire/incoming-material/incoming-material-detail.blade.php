<div>
    @if ($showDetail && $material)
        ...
        {{-- OVERLAY --}}
        <div class="fixed inset-0 z-[9999] bg-black/50 backdrop-blur-sm">

            {{-- WRAPPER (SCROLL DI DALAM, BUKAN DI OVERLAY) --}}
                       ...
                       max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="px-6 py-4 border-t bg-gray-50 flex justify-end rounded-b-2xl">
                            <button wire:click="closeDetail"
                                class="px-4 py-2 text-xs rounded-xl bg-gray-100 hover:bg-gray-200">
                                Tutup
                            </button>
                        </div>
