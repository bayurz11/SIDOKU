        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                ...
                @permission('documents.import')
                    <button wire:click="$dispatch('openDocumentImportForm', { mode: 'import' })"
                        class="group inline-flex items-center px-5 py-2.5 rounded-xl text-sm font-semibold border-2 border-green-600 text-green-700 bg-white hover:text-white hover:border-transparent hover:bg-gradient-to-r hover:from-emerald-500 hover:via-green-500 hover:to-lime-500 transition-all duration-300 hover:shadow-lg active:scale-[0.97]">
                        {{-- ICON Import (Outline, tidak berubah) --}}
