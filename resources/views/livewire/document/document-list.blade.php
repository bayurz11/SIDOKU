                                ...
                                @permission('documents.edit')
                                    ...
                                    @if ($doc->status !== 'obsolete')
                                        <button wire:click="markObsolete({{ $doc->id }})"
                                            class="inline-flex items-center px-3 py-2 text-xs font-semibold text-Yellow-700 bg-red-50 rounded-lg hover:bg-Yellow-100 hover:text-Yellow-800 transition-all duration-200">
                                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
