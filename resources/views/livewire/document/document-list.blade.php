            ...
            <div class="flex items-center gap-2">
                ...
                @permission('documents.import')
                    <button wire:click="$dispatch('openDocumentForm')"
                        class="group border-2 border-green-600 text-green-700 bg-white 
 hover:bg-gradient-to-r hover:from-green-600 hover:to-purple-600 hover:text-white px-6 py-3 rounded-xl text-sm font-semibold flex items-center transition-all duration-300 hover:shadow-xl hover:scale-105">
