                            ...
                            <div class="flex items-center gap-2">
                                @permission('documents.view')
                                    <button wire:click="showDetail({{ $doc->id }})"
                                        class="group inline-flex items-center px-4 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-600 hover:from-indigo-700 hover:to-indigo-700 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-[1.03]">
