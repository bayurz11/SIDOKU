            ...
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        Kelola daftar dokumen (DOC, SOP, WI, FORM) beserta status dan departemennya.
                    </p>
                </div>
            </div>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                            <div class="flex flex-wrap gap-2">
                                @permission('documents.view')
                                    {{-- View/Download --}}
                                    @if ($doc->file_path)
                                        <a href="{{ asset('storage/' . ltrim($doc->file_path, '/')) }}" target="_blank"
                                            class="group/btn inline-flex items-center px-3 py-2 text-xs font-semibold text-emerald-700 bg-emerald-50 rounded-lg hover:bg-emerald-100 hover:text-emerald-800 transition-all duration-200 transform hover:scale-105">
                                ...
                                @permission('documents.edit')
                                    ...
                                    @if ($doc->status !== 'obsolete')
                                        <button wire:click="markObsolete({{ $doc->id }})"
                                            class="group/btn inline-flex items-center px-3 py-2 text-xs font-semibold text-orange-700 bg-orange-50 rounded-lg hover:bg-orange-100 hover:text-orange-800 transition-all duration-200 transform hover:scale-105">
                                            <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
