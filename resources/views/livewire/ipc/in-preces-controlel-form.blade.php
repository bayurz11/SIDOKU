            ...
            <div class="relative top-8 mx-auto p-6 border w-full max-w-4xl shadow-lg rounded-2xl bg-white"
                ...
                <div class="mt-1">
                    ...
                    <form wire:submit.prevent="save" class="space-y-6">
                        ...
                        {{-- PARAMETER IPC SESUAI LINE (client-side pakai Alpine) --}}
                        <div class="border border-blue-100 rounded-lg p-4 bg-blue-50/40 space-y-4">
                            ...
                            {{-- Pesan: belum pilih line --}}
                            <p class="text-xs text-gray-500 italic" x-show="!lineGroup" x-cloak>
                                Pilih <strong>Line Group</strong> terlebih dahulu untuk menampilkan parameter yang
                                sesuai.
                            </p>

                            {{-- LINE TEH --}}
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4" x-show="lineGroup === 'LINE_TEH'"
                                x-cloak>
                                <div>
                                    <label for="avg_weight_g" class="block text-xs font-medium text-gray-700 mb-1.5">
                            ...
                            {{-- LINE POWDER --}}
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4" x-show="lineGroup === 'LINE_POWDER'"
                                x-cloak>
                                <div>
                                    <label for="avg_weight_g" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata Berat (g)
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4"
                                x-show="lineGroup === 'LINE_MINUMAN_BERPERISA'" x-cloak>
                                <div>
                                    <label for="avg_ph" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata pH
                                    </label>
                                ...
                                <div>
                                    <label for="avg_tds_ppm" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata TDS (ppm)
                                    </label>
                            ...
                            {{-- LINE AMDK --}}
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4" x-show="lineGroup === 'LINE_AMDK'"
                                x-cloak>
                                <div>
                                    <label for="avg_ph" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata pH
                                ...
                                <div>
                                    <label for="avg_chlorine" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata Klorin
                                    </label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-4 gap-4"
                                x-show="lineGroup === 'LINE_CONDIMENTS'" x-cloak>
                                <div>
                                    <label for="avg_ph" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata pH
                                    </label>
                                ...
                                <div>
                                    <label for="avg_salinity" class="block text-xs font-medium text-gray-700 mb-1.5">
                                        Rata-rata Salinitas
                                    </label>
