...
@push('scripts')
    ...
    <script>
        (function() {
            ...
            h backgroundColor & borderColor dalam bentuk array buat setiap bar,
                lalu cek apakah nilai≥ 10. Kalau iya→ merah, kalau tidak→ hijau.Hanya di ipcMoistureChart.

            Di bagian JS kamu, ubah
            function renderIpcMoistureCharts() jadi seperti ini(fokus di BAR CHART saja):
                ...
                function renderIpcMoistureCharts() {
                    ...
                    if (!labels.length || !dataValues.length) {
                        ...
                        if (window.ipcMoistureDonutChart && typeof window.ipcMoistureDonutChart.destroy ===
                            'function') {
