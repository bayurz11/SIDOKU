                        ...
                        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                            <div>
                                ...
                                <ul class="list-disc list-inside space-y-0.5">
                                    <li>
                                        <code class="font-mono text-[11px]">line_group</code>
                                        (wajib, gunakan key di Master Line, mis: <code
                                            class="font-mono text-[11px]">LINE_TEH</code>,
                                        <code class="font-mono text-[11px]">LINE_POWDER</code>)
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">sub_line</code>
                                        (opsional, wajib &amp; harus valid jika
                                        <code class="font-mono text-[11px]">line_group = LINE_TEH</code>)
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">test_date</code>
                                        (wajib, format tanggal atau Excel date)
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">product_name</code>
                                        (wajib)
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">shift</code>
                                        (opsional, 1–3)
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">cup_weight</code>,
                                        <code class="font-mono text-[11px]">product_weight</code>
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">weighing_1</code>,
                                        <code class="font-mono text-[11px]">weighing_2</code>
                                        <span class="block">
                                            (jika ke-4 kolom di atas diisi, sistem akan hitung
                                            <code class="font-mono text-[11px]">avg_moisture_percent</code>
                                            &amp; <code class="font-mono text-[11px]">avg_weight_g</code> otomatis)
                                        </span>
                                    </li>
                                    <li>
                                        <code class="font-mono text-[11px]">notes</code>
                                        (opsional)
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="shrink-0">
                                {{-- Ganti route ini dengan nama route template IPC yang kamu pakai --}}
                                <a href="{{ route('ipc.product-checks.import-template') }}"
                        ...
                        <label
                            ...
                            <div class="flex flex-col items-center text-emerald-600">
                                ...
                                <p class="text-[11px] text-gray-500 mt-1">
                                    Format yang didukung: .xlsx, .xls (maks 10 MB)
                                </p>
                            </div>
